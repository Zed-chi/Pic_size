  ...
  <div class="w3-container w3-dark-grey w3-card-4">
     <a href="index.php"><h1 class="w3-center w3-xxlarge">back to Image loader</h1></a>
  </div>

  <div class="w3-card-4 w3-grey w3-padding w3-round-large" style="margin:10% 10%">
    <h1 class="w3-center w3-xxlarge w3-text-white">Your Files:</h1>
    <ul class="w3-ul">
<?php
...
?>
    ...
    <label class="w3-validate">Make First as Pattern</label>
  </div>
...
<div id="id01" class="w3-modal">
  ...
  <button id="show" type="hidden">ShowArray</button>
  <button id="show2" type="hidden">datashow</button>
